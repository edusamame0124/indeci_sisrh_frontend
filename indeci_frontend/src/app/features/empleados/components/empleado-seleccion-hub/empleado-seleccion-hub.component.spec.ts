...
describe('EmpleadoSeleccionHubComponent', () => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        provideRouter([
          ...
          { path: 'empleados/cuentas-bancarias/personas/:id', component: HubRouteBlankComponent },
        ]),
  ...
  it('tabla con scroll, paginador y acciones ícono + aria-label', () => {
    ...
    const firstLink = host.querySelector('td a.mat-mdc-icon-button') as HTMLAnchorElement | null;
    expect(firstLink?.hasAttribute('disabled')).toBe(false);
  });

  it('deshabilita acción cuando empleadoId no viene del API', () => {
    const httpMock = TestBed.inject(HttpTestingController);
    const fixture = TestBed.createComponent(EmpleadoSeleccionHubComponent);
    const host = fixture.nativeElement as HTMLElement;
    fixture.detectChanges();
    ...
    httpMock.expectOne('/api/rrhh/persona').flush({
      ...
      data: [
        {
          id: 7,
          nombreCompleto: 'SIN EMPLEADO ID',
          dni: '11111111',
          email: 'x@mail.local',
          codigoInterno: 'EMP00999',
        },
      ],
    });
    fixture.detectChanges();

    const link = host.querySelector('td a.mat-mdc-icon-button') as HTMLAnchorElement | null;
