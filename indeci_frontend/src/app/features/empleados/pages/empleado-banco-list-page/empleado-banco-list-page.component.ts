...
@Component({
  ...
  template: `
    <div class="page sisrh-page">
      ...
      <div class="actions">
        <a mat-button routerLink="/empleados/cuentas-bancarias">Volver</a>
        @if (canEdit()) {
          <a
            mat-flat-button
            color="primary"
            [routerLink]="['/empleados/cuentas-bancarias/personas', personaId(), 'nueva']"
          >
            Registrar cuenta
          </a>
        }
          ...
          <mat-card-content>
            @if (tableLoading()) {
              ...
              <app-empty-state
                ...
                description="Este colaborador no tiene cuentas activas registradas."
              />
            } @else {
              ...
              <table mat-table [dataSource]="pagedRows()" class="tbl">
                <ng-container matColumnDef="banco">
                  ...
                  <td mat-cell *matCellDef="let row">{{ row.bank || ('ID ' + row.bankId) }}</td>
                </ng-container>
                ...
                <ng-container matColumnDef="numeroCuenta">
                  ...
                  <td mat-cell *matCellDef="let row" class="sisrh-tabular">{{ row.numeroCuenta }}</td>
                </ng-container>
                <ng-container matColumnDef="cci">
                  <th mat-header-cell *matHeaderCellDef scope="col">CCI</th>
                  <td mat-cell *matCellDef="let row" class="sisrh-tabular">{{ row.cci || '—' }}</td>
                </ng-container>
                ...
                <ng-container matColumnDef="acciones">
                  ...
                  <td mat-cell *matCellDef="let row">
                    <a
                      mat-icon-button
                      [routerLink]="[
                        '/empleados/cuentas-bancarias/personas',
                        personaId(),
                        'editar',
                        row.id,
                      ]"
